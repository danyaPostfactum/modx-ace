...
$_lang['ui_ace.case_sensitive'] = 'Учитывать регистр';
$_lang['ui_ace.close'] = 'Закрыть';
$_lang['ui_ace.find'] = 'Найти';
$_lang['ui_ace.go'] = 'Перейти';
$_lang['ui_ace.goto_line'] = 'Перейти к строке';
$_lang['ui_ace.replace'] = 'Заменить';
$_lang['ui_ace.replace_with'] = 'Заменить на';
$_lang['ui_ace.replace_all'] = 'Заменить все';
...
$_lang['setting_ace.theme_desc'] = 'Доступные темы: ambiance, chaos, chrome, clouds, clouds_midnight, cobalt, crimson_editor, dawn, dreamweaver, eclipse, github, idle_fingers, kr, merbivore, merbivore_soft, mono_industrial, monokai, pastel_on_dark, solarized_dark, solarized_light, textmate, tomorrow, tomorrow_night, tomorrow_night_blue, tomorrow_night_bright, tomorrow_night_eighties, twilight, vibrant_ink, xcode.';
