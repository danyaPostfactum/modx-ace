...
$_lang['ui_ace.replace_all']         = 'Alle ersetzen';
$_lang['ui_ace.message_replaced']    = 'Ersetzt: [[+count]].';
$_lang['ui_ace.search_wrap']         = 'Am Anfang fortsetzen';
$_lang['ui_ace.whole_word']          = 'Ganze W&ouml;rter';

$_lang['area_general']               = 'Allgemeine Einstellungen';

$_lang['setting_ace.theme']          = 'Editor Thema';
$_lang['setting_ace.theme_desc']     = 'Verf&uuml;gbare Themen: ambiance, chaos, chrome, clouds, clouds_midnight, cobalt, crimson_editor, dawn, dreamweaver, eclipse, exside, github, idle_fingers, kr, merbivore, merbivore_soft, mono_industrial, monokai, pastel_on_dark, solarized_dark, solarized_light, terminal, textmate, tomorrow, tomorrow_night, tomorrow_night_blue, tomorrow_night_bright, tomorrow_night_eighties, twilight, vibrant_ink, xcode.';
